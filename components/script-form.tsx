...
import { generateScript } from "../lib/script-generation-actions"
          ...
          <Card className="border-0 shadow-md">
            <CardContent className="p-6">
              ...
              <div className="prose prose-gray max-w-none">
                <div className="whitespace-pre-wrap text-gray-800 leading-relaxed bg-gray-50 p-4 rounded-lg border">
                  {result?.script}
                </div>
              </div>
            </CardContent>
