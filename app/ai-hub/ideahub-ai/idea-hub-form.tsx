...
const topicOptions = [
  ...
  "What's the difference between picture day and listing day?",
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Textarea
            id="alternateTopic"
            name="alternateTopic"
            placeholder="Enter any custom topic or additional details you'd like to include, or click the microphone to speak"
          ...
          <Button
            ...
            onClick={() => (isListening ? stopListening() : startListening("alternateTopic"))}
