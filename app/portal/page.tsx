...
import { Brain, Megaphone, GraduationCap, Wrench, Network, ShoppingBag, Target, BookOpen } from "lucide-react"
...
export default function PortalPage() {
  ...
  const isBeggins = tenantConfig.id === "century21-beggins"
      ...
      ? [
          {
            ...
            description: "Your comprehensive guide to getting started and succeeding",
            icon: BookOpen,
            href: "/onboarding-hub",
