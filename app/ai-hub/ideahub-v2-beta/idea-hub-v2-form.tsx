...
import { generateContentV2 } from "./actions"
...
export default function IdeaHubV2Form() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const generatedContent = await generateContentV2(formData)
    ...
    <div ref={resultsRef} className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Here's your professionally generated social media content with high-quality imagery and Century 21 branding
        </p>
      </div>
